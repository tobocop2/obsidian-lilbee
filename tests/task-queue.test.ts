...
describe("TaskQueue", () => {
    ...
    describe("enqueue()", () => {
        ...
        it("queues additional tasks when one is active", () => {
            queue.enqueue("Task 1", TASK_TYPE.SYNC);
            const id2 = queue.enqueue("Task 2", TASK_TYPE.ADD);

            const active = queue.active;
            const queued = queue.queued;

            expect(active!.name).toBe("Task 1");
    ...
    describe("cancel()", () => {
        ...
        it("cancels a queued task that hasn't started yet", () => {
            ...
            const id2 = queue.enqueue("Task 2", TASK_TYPE.SYNC);
            const id3 = queue.enqueue("Task 3", TASK_TYPE.ADD);
    ...
    describe("edge cases", () => {
        ...
        it("handles moveToHistory when task not found", () => {
            queue.enqueue("Task 1", TASK_TYPE.SYNC);
            queue.enqueue("Task 2", TASK_TYPE.SYNC);
            ...
            const active2 = queue.active;
            expect(active2).not.toBeNull();
            expect(active2!.name).toBe("Task 2");
        ...
        it("returns null from active when task was deleted externally", () => {
            ...
            (queue as any).tasks.delete((queue as any).activeId);
