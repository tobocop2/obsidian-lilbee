...
/** The input or text area inside a text component: a MockElement that also carries the input's type. */
function mockInputEl(): MockElement & { type: string } {
    return Object.assign(new MockElement("input"), { type: "text" });
}
