...
- **Managed mode covers Apple Silicon and Intel Macs, Linux x64, and Windows x64.** On any other machine, use external mode: install lilbee by following the [official install instructions](https://github.com/tobocop2/lilbee#install), run `lilbee serve` yourself, and point the plugin at it from Settings → Connection.
