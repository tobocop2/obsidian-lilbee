...
export const MESSAGES = {
    ...
    DESC_CRAWL_MAX_DEPTH: "How many links deep to follow (0 = just the page itself)",
    DESC_CRAWL_MAX_PAGES: "Maximum number of pages to crawl from a website",
