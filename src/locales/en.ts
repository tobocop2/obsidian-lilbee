...
export const MESSAGES = {
    ...
    LABEL_RESET_ALL_SETTINGS: "Reset all settings to defaults",
    DESC_RESET_ALL_SETTINGS: "Restore every setting below to its server default. API keys are preserved.",
    CONFIRM_RESET_ALL_SETTINGS: "Reset every setting to its server default? Your custom values will be lost.",
