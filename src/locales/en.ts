...
export const MESSAGES = {
    ...
    LABEL_SERVER_TOKEN: "Server token",
    ...
    DESC_SERVER_TOKEN:
        "Bearer token for authenticating against the external server. Find it in the server's data dir at data/server.json. Leave blank if the server has auth disabled.",
    ...
    PLACEHOLDER_SERVER_TOKEN: "Paste server.json token (leave blank if auth disabled)",
    PLACEHOLDER_SK: "sk-...",
    ...
    LABEL_STATUS_VISION_MODEL: "Vision model",
