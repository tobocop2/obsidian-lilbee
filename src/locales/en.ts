...
export const MESSAGES = {
    ...
    LABEL_EXPORT_CHAT: "Export chat…",
    LABEL_MARKDOWN_FILTER: "Markdown",
    ...
    NOTICE_SESSION_FORKED: (title: string): string => `Forked · ${title}`,
    ...
    STATUS_CHAT_FAILED: "lilbee: chat model failed",
    STATUS_WARM_STARTING: "lilbee: preparing the model",
    STATUS_WARM_READING: (percent: number): string => `lilbee: reading weights ${percent}%`,
    STATUS_WARM_READING_UNSIZED: "lilbee: reading weights",
    ...
    REASON_NOT_A_NUMBER: "enter a number",
    REASON_NOT_WHOLE_NUMBER: "enter a whole number",
    REASON_AT_LEAST: (min: number) => `enter ${min} or more`,
    REASON_BETWEEN: (min: number, max: number) => `enter a number from ${min} to ${max}`,
    ...
    NOTICE_CHAT_EXPORTED: (path: string) => `Exported chat to ${path}`,
    ERROR_CHAT_EXPORT_FAILED: (reason: string) => `Could not export chat: ${reason}`,
    ...
    COMMAND_FORK_CHAT: "Fork current chat",
    COMMAND_EXPORT_CHAT: "Export current chat to a file",
    ...
    LABEL_STATUS_WIKI_LINT: "Lint",
    LABEL_STATUS_NONE: "none",
    VALUE_STATUS_WIKI_LINT: (errors: number, warnings: number): string => `${errors} errors, ${warnings} warnings`,
