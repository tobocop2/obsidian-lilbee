// Interactivity for the lilbee for Obsidian landing page: the demo reel's
// tab navigation and the copy-to-clipboard button on the install slug.

(function () {
  'use strict';

  /** Wire every [role="tablist"] on the page (the demo reel). Click selection
      plus left/right arrow-key navigation. */
