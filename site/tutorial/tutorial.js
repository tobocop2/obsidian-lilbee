...
const groups = [
  ...
  },
  {
    ...
    reels: [
      ...
      { id: "placement", name: "placement", title: "Spread models across your GPUs", desc: "On a box with four GPUs, the placement view draws every card and what's running on it. Spread chat across all four, pin an embedding worker, apply, then re-index a whole codebase and watch each card's load update live as it runs. Then ask a grounded question about what was just indexed. On a single machine it stays simple: one card, everything together, nothing to set up." },
    ],
  },
  {
